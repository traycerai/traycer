...
Model, permission, thinking effort, and fast-mode changes apply to the next agent turn. They do not rewrite a turn that already started. The exception is switching to [Auto](#auto-mode), which applies right away.
