...
// 1.4 reopens `core.settings.permissionMode` from a closed enum to a checked
...
// from enum to string is additive for a reader: every value a 1.3 record can
// carry still parses, and the reverse direction is what the reopening exists
// to survive. `CHAT_SYNC_1_1_READER_FLOOR` is NOT raised and a 1.4 head still
