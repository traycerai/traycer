...
const baseTuiAgentFields = {
  ...
  hostId: lazySchema(() => z.string()),
  userId: lazySchema(() => z.string()),
  workspaceFolders: lazySchema(() => z.array(z.string())),
  workspaceMode: lazySchema(() =>
    worktreeBindingWorkspaceModeSchema.optional(),
  ),
  model: lazySchema(() => z.string().nullable()),
  reasoningEffort: lazySchema(() => z.string().nullable().default(null)),
  agentMode: agentModeSchema,
  terminalAgentArgs: lazySchema(() =>
    z.string().nullable().default(null).catch(null),
  ),
  terminalShellCommand: lazySchema(() => z.string().nullable().catch(null)),
  terminalShellArgs: lazySchema(() =>
  ...
  profileId: lazySchema(() => z.string().nullable().default(null).catch(null)),
  ...
  // parse unchanged.
  archivedAt: lazySchema(() => z.number().nullable().default(null)),
  ...
  pendingForkSourceHarnessSessionId: lazySchema(() =>
    z.string().nullable().default(null).catch(null),
  ),
  ...
  pinnedUserProviderHandle: lazySchema(() =>
    z.string().nullable().default(null).catch(null),
  ),
  ...
  // this contract.
  lastDeliveredRolesDigest: lazySchema(() =>
    z.string().nullable().default(null).catch(null),
  ),
} as const;

export const claudeTuiAgentSchema = lazySchema(() =>
  z.object({
...
export const codexTuiAgentSchema = lazySchema(() =>
  z.object({
...
export const opencodeTuiAgentSchema = lazySchema(() =>
  z.object({
...
export const cursorTuiAgentSchema = lazySchema(() =>
  z.object({
...
export const tuiAgentSchema = lazySchema(() =>
