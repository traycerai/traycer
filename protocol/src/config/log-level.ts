/**
 * Log-level vocabulary shared by every Traycer logger - the host, the CLI, the desktop main process, and the GUI renderer.
 */
 ...
 * There is no "off" - `error` always passes - so a quiet setting can never hide a failure.
 */
