...
/**
 * What a transport can currently say about whether the connected host serves
 * a stream method: `"unknown"` until the handshake (or a subscribe attempt)
 * has produced evidence either way.
 */
