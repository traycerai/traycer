...
export const githubMentionSectionSchema = lazySchema(() =>
  z.enum(["pull-requests", "issues"]),
);
export type GithubMentionSection = z.infer<typeof githubMentionSectionSchema>;

export const githubCatalogRefreshSchema = lazySchema(() =>
  z.enum(["none", "auto", "manual"]),
);
export type GithubCatalogRefresh = z.infer<typeof githubCatalogRefreshSchema>;

export const githubMentionBucketSchema = lazySchema(() =>
  z.enum([
    "epic",
    "review-requested",
    "assigned",
...
export const githubMentionRepositorySchema = lazySchema(() =>
  z.object({
...
const githubMentionRowBaseSchema = lazySchema(() =>
  githubMentionRepositorySchema.extend({
...
export const githubPullRequestMentionRowSchema = lazySchema(() =>
...
export const githubIssueMentionRowSchema = lazySchema(() =>
  githubMentionRowBaseSchema.extend({
...
export const githubMentionRowSchema = lazySchema(() =>
...
export const githubPullRequestMentionFilterSchema = lazySchema(() =>
  z.object({
...
export const githubIssueMentionFilterSchema = lazySchema(() =>
  z.object({
...
const githubMentionRequestBaseSchema = lazySchema(() =>
  z.object({
...
export const mentionGithubCatalogRequestSchema = lazySchema(() =>
...
export const mentionGithubCatalogResponseSchema = lazySchema(() =>
  z.object({
...
export const mentionGithubSearchRequestSchema = lazySchema(() =>
...
export const mentionGithubSearchResponseSchema = lazySchema(() =>
  z.object({
    rows: z.array(githubMentionRowSchema),
    sourceStatus: prSourceStatusSchema,
    notice: prSourceNoticeSchema.nullable(),
