...
export const rebindLocalStoreRequestSchema = lazySchema(() =>
  z.object({ confirmOldHostStopped: z.literal(true) }).strict(),
);
export type RebindLocalStoreRequest = z.infer<
  typeof rebindLocalStoreRequestSchema
>;

export const rebindLocalStoreResponseSchema = lazySchema(() =>
