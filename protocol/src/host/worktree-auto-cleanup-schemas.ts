 ...
 */
export const worktreeAutoCleanupPausedReasonSchema = lazySchema(() =>
  z.enum([
 ...
 * protocol change.
 */
export const worktreeAutoCleanupPolicyBoundsSchema = lazySchema(() =>
  z.object({
 ...
 */
export const worktreeAutoCleanupPolicySchema = lazySchema(() =>
  z.object({
    enabled: z.boolean(),
 ...
 * the policy file.
 */
export const worktreeAutoCleanupSchedulerStateSchema = lazySchema(() =>
  z.object({
 ...
 */
export const worktreeAutoCleanupPolicyStateSchema = lazySchema(() =>
  z.object({
...
export const worktreeGetAutoCleanupPolicyRequestSchema = lazySchema(() =>
  z.object({}),
);
 ...
 */
export const worktreeSetAutoCleanupPolicyRequestSchema = lazySchema(() =>
  z.object({
    enabled: z.boolean(),
    inactivityDays: z.number().int().positive(),
 ...
 * "still working".
 */
export const worktreeAutoCleanupRunStatusSchema = lazySchema(() =>
  z.enum(["running", "completed", "interrupted"]),
);
 ...
 */
export const worktreeAutoCleanupRunSummarySchema = lazySchema(() =>
  z.object({
    runId: idSchema,
 ...
 */
export const worktreeAutoCleanupEligibleTierSchema = lazySchema(() =>
  z.enum(["merged", "at-base-commit", "unreferenced"]),
);
 ...
 */
export const worktreeAutoCleanupTargetOutcomeSchema = lazySchema(() =>
  z.enum(["deleted", "skipped", "failed", "interrupted"]),
);
 ...
 */
export const worktreeAutoCleanupTargetSchema = lazySchema(() =>
  z.object({
    targetId: idSchema,
    runId: idSchema,
 ...
 */
export const worktreeListAutoCleanupRunsRequestSchema = lazySchema(() =>
  z.object({
...
export const worktreeListAutoCleanupRunsResponseSchema = lazySchema(() =>
  z.object({
...
export const worktreeGetAutoCleanupRunRequestSchema = lazySchema(() =>
  z.object({
    runId: idSchema,
  }),
);
 ...
 * minor.
 */
export const worktreeGetAutoCleanupRunResponseSchema = lazySchema(() =>
  z
    .object({
