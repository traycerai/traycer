...
const viewportEdgeSchema = lazySchema(() =>
  z
    .number()
    .int()
...
export const browserViewportSizeSchema = lazySchema(() =>
  z
...
export const browserViewportIntentSchema = lazySchema(() =>
...
export const browserViewportGeometrySchema = lazySchema(() =>
  z
    .object({
...
export const browserViewportStateSchema = lazySchema(() =>
  z
    .object({
      sessionId: z.string(),
      tabId: z.string(),
