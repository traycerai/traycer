...
export const speechDownloadStateSchema = lazySchema(() =>
  z.enum(["absent", "downloading", "ready", "error"]),
);
...
export const speechModelDiskStatusSchema = lazySchema(() =>
  z.object({
    modelId: z.string(),
    installed: z.boolean(),
...
export const speechModelStatusSchema = lazySchema(() =>
  speechModelDiskStatusSchema.extend({
