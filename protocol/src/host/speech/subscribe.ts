...
export const speechDictateOpenRequestSchema = lazySchema(() =>
  z.object({
...
export const speechDictateServerFrameSchema = lazySchema(() =>
...
export const speechDictateClientFrameSchema = lazySchema(() =>
  z.discriminatedUnion("kind", [
