...
describe("released floor production module", () => {
  ...
  it("advertises every host.notifications unary method as an optional capability", () => {
    ...
    // Latest advertised major for list is 2 (native projections), at minor 2 (the `browser.human.needed` arm, after 2.1's `host.operation.finished`); major 1 remains registered for the frozen all/unread bridge, and 2.0/2.1.
