 ...
 */
export const chatBackupStatusRequestSchema = lazySchema(() =>
  z.object({
...
export const chatBackupHaltCauseSchema = lazySchema(() =>
  z.enum([
    "conflict",
    "quarantined",
    "repair-pending",
...
export const chatBackupPublicationStatusSchema = lazySchema(() =>
  z.enum(["current", "behind", "unknown"]),
);
export type ChatBackupPublicationStatus = z.infer<
  typeof chatBackupPublicationStatusSchema
>;

export const chatBackupStatusRowSchema = lazySchema(() =>
  z.object({
...
export const chatBackupStatusResponseSchema = lazySchema(() =>
  z.object({
