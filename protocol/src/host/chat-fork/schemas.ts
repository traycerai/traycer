...
export const chatForkCauseSchema = lazySchema(() =>
  z.enum(["sibling-of-receipt", "unrelated-lineage", "indeterminate"]),
);
...
export const chatForkCandidateSummarySchema = lazySchema(() =>
  z.object({
...
export const chatForkChatNoticeSchema = lazySchema(() =>
  z.object({
...
export const chatForkEventSchema = lazySchema(() =>
  z.object({
...
export const chatForkGetRequestSchema = lazySchema(() => z.object({}));
export type ChatForkGetRequest = z.infer<typeof chatForkGetRequestSchema>;

export const chatForkGetResponseSchema = lazySchema(() =>
  z.object({
