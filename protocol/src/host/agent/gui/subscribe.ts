...
const chatWindowedSnapshotSchemaV113 = chatWindowedSnapshotSchemaV111.extend({
...
export const chatWindowedSnapshotSchema = chatWindowedSnapshotSchemaV113.extend(
  {
    queue: chatQueueStateSchema,
