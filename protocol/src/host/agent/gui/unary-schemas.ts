...
export const harnessSurfaceSchema = lazySchema(() => z.enum(["gui", "tui"]));
...
export const guiHarnessUnavailableReasonSchema = lazySchema(() =>
  z.enum([
    "missing-binary",
    "missing-credential",
...
export const guiHarnessOptionSchema = lazySchema(() =>
  z.object({
...
export const agentReasoningEffortOptionSchema = lazySchema(() =>
  z.object({
    id: z.string(),
    label: z.string(),
...
export const agentServiceTierOptionSchema = lazySchema(() =>
  z.object({
    id: z.string(),
    label: z.string(),
    description: z.string().nullable(),
...
export const guiAgentModelCapabilitiesSchema = lazySchema(() =>
  z.object({
...
export const guiAgentModelOptionSchema = lazySchema(() =>
  z.object({
...
export const agentCommandKindSchema = lazySchema(() =>
  z.enum(["slash-command", "skill"]),
);
export type AgentCommandKind = z.infer<typeof agentCommandKindSchema>;

export const guiAgentCommandOptionSchema = lazySchema(() =>
  z.object({
    harnessId: guiHarnessIdSchema,
    name: z.string(),
...
export const listGuiHarnessesRequestSchema = lazySchema(() => z.object({}));
export type ListGuiHarnessesRequest = z.infer<
  typeof listGuiHarnessesRequestSchema
>;

export const listGuiHarnessesResponseSchema = lazySchema(() =>
  z.object({
...
export const guiHarnessOptionSchemaV10 = lazySchema(() =>
  z.object({
...
export const listGuiHarnessesResponseSchemaV10 = lazySchema(() =>
  z.object({
...
export const guiHarnessOptionSchemaV20 = lazySchema(() =>
  guiHarnessOptionSchemaV10.extend({
    id: guiHarnessIdSchemaV20,
    availabilityPending: z.boolean().catch(false),
  }),
);
export const listGuiHarnessesResponseSchemaV20 = lazySchema(() =>
  z.object({
...
const guiHarnessOptionBaseShapeV70 = {
  ...
  enabled: lazySchema(() => z.boolean().default(true)),
  available: lazySchema(() => z.boolean()),
  error: lazySchema(() => z.string().nullable()),
  modes: lazySchema(() => z.array(harnessSurfaceSchema)),
  requiresApiKey: lazySchema(() => z.boolean()),
  supportedPermissionModes: lazySchema(() =>
    z
      .array(permissionModeSchemaPreAuto)
      .default([...ALL_PERMISSION_MODES_PRE_AUTO]),
  ),
...
export const guiHarnessOptionSchemaV21 = lazySchema(() =>
  z.object({
    id: guiHarnessIdSchemaV20,
    ...guiHarnessOptionBaseShapeV70,
  }),
);
export const listGuiHarnessesResponseSchemaV21 = lazySchema(() =>
  z.object({
...
// parse.
export const guiHarnessOptionSchemaV30 = lazySchema(() =>
  z.object({
    id: guiHarnessIdSchemaV30,
    ...guiHarnessOptionBaseShapeV70,
  }),
);
export const listGuiHarnessesResponseSchemaV30 = lazySchema(() =>
  z.object({
...
export const guiHarnessOptionSchemaV40 = lazySchema(() =>
  z.object({
    id: guiHarnessIdSchemaV40,
    ...guiHarnessOptionBaseShapeV70,
  }),
);
export const listGuiHarnessesResponseSchemaV40 = lazySchema(() =>
  z.object({
...
export const guiHarnessOptionSchemaV50 = lazySchema(() =>
  z.object({
    id: guiHarnessIdSchemaV50,
    ...guiHarnessOptionBaseShapeV70,
  }),
);
export const listGuiHarnessesResponseSchemaV50 = lazySchema(() =>
  z.object({
...
export const guiHarnessOptionSchemaV60 = lazySchema(() =>
  z.object({
    id: guiHarnessIdSchemaV60,
    ...guiHarnessOptionBaseShapeV70,
  }),
);
export const listGuiHarnessesResponseSchemaV60 = lazySchema(() =>
  z.object({
...
export const guiHarnessOptionSchemaV70 = lazySchema(() =>
  z.object({
    id: guiHarnessIdSchemaV70,
    ...guiHarnessOptionBaseShapeV70,
  }),
);
export const listGuiHarnessesResponseSchemaV70 = lazySchema(() =>
  z.object({
...
const guiHarnessOptionBaseShapeV71 = {
  ...guiHarnessOptionBaseShapeV70,
  authStatus: lazySchema(() =>
    PROVIDER_AUTH_STATUS_SCHEMA.optional().catch(undefined),
  ),
};

export const guiHarnessOptionSchemaV71 = lazySchema(() =>
  z.object({
    id: guiHarnessIdSchemaV70,
    ...guiHarnessOptionBaseShapeV71,
  }),
);
export const listGuiHarnessesResponseSchemaV71 = lazySchema(() =>
  z.object({
...
export const guiHarnessOptionSchemaV80 = lazySchema(() =>
  z.object({
    id: guiHarnessIdSchemaV80,
    ...guiHarnessOptionBaseShapeV71,
  }),
);
export const listGuiHarnessesResponseSchemaV80 = lazySchema(() =>
  z.object({
...
export const listGuiHarnessesResponseSchemaV90 = lazySchema(() =>
  z.object({
...
export const listGuiAgentModelsRequestSchema = lazySchema(() =>
  z.object({
    harnessId: guiHarnessIdSchema,
...
export const listGuiAgentModelsResponseSchema = lazySchema(() =>
  z.object({
    harnessId: guiHarnessIdSchema,
...
export const listGuiAgentCommandsRequestSchema = lazySchema(() =>
  z.object({
    harnessId: guiHarnessIdSchema,
    workingDirectory: z.string().nullable(),
...
export const listGuiAgentCommandsResponseSchema = lazySchema(() =>
  z.object({
    harnessId: guiHarnessIdSchema,
...
export const getGuiAgentPlanRequestSchema = lazySchema(() =>
  z.object({
    epicId: z.string(),
    chatId: z.string(),
    planId: z.string(),
...
export const getGuiAgentPlanUnavailableReasonSchema = lazySchema(() =>
  z.enum(["blob_missing"]),
);
...
export const getGuiAgentPlanResponseSchema = lazySchema(() =>
  z.object({
    planId: z.string(),
    markdown: z.string(),
