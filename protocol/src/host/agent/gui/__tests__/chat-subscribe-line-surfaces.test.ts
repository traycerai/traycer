...
// `1.15` (message delivery), `1.16` (approval tier), `1.17` (sender host)
// and `1.18` (identity on the active turn) mint no boundary a needle below
// can pin, so only the ceiling names them.
const IDENTITY_MINOR = 18;
const LIVE_MINOR = IDENTITY_MINOR;
