...
describe("chat.subscribe registry: 1.16 installed below the 1.17 and 1.18 lines, 1.15 still installed", () => {
  ...
  it("1.18's server frame is the windowed schema; 1.17's, 1.16's and 1.15's are distinct, frozen ones", () => {
