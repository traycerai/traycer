 ...
 * response schema. Private on purpose: the only structural-only caller is
 * construction, and a dynamic registry must not be able to reach the
 * validated brand through it.
 */
