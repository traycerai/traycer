 ...
 * The verifier is generated and kept in-memory by the shell at sign-in start; only its S256 challenge travels in the sign-in URL, so a leaked redirect URL never exposes the secret needed to exchange the auth code.
 */
