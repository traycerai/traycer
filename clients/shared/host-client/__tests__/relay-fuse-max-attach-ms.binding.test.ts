...
/**
 * Cross-repo binding for the relay attach fuse (audit F23).
 * No import path bridges the two repos, so this is a golden-value assertion, not a real binding - it exists so an edit to either constant alone fails a test in that side's own CI, naming the other side.
 */
