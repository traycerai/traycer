...
/** The result kinds are returned rather than thrown - the sign-in surface renders them inline next to the code field, so a wrong code is an ordinary state with the field still focused, not a toast. */
