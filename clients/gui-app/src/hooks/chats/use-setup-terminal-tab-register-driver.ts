...
/** Chat's setup-terminal tab register driver: sources the worktree binding from the chat's live `chat.subscribe` store and delegates the registration effect to `useRegisterSetupTerminalTabsFromBinding` (see there for the behavior and the once-per-view guarantees). */
