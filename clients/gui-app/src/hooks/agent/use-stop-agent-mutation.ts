...
/** The host aborts a GUI turn or interrupts a TUI CLI (Ctrl+C, tab kept alive) by surface, and clears the agent's in-flight inter-agent traffic so the subtree can't revive itself. */
