export const managedCommandMutationKeys = {
  ...
  // Scoped to ONE command on ONE host: the shared pending read exists so a
  // switch pressed in the list row also reads pending in the output window
  // header for the same command - and only there.
