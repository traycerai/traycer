...
export const SETTINGS_SEARCH_ENTRIES: ReadonlyArray<SettingsSearchEntry> = [
  ...
  },
  {
    ...
    description: null,
    group: null,
    keywords: ["dark mode", "light mode", "colors", "palette"],
  },
  {
    section: "appearance",
    ...
    group: "Theme",
    keywords: ["dark mode", "light mode", "night", "system", "contrast"],
  },
  {
    section: "appearance",
    ...
    label: "Preset",
    description:
      "Pick a named palette. Full-palette presets override the base surface colors.",
    group: "Theme",
    keywords: [
      "palette",
      "colors",
  ...
  // --------------------------------------------- Notifications (application)
  {
    ...
    group: null,
    keywords: ["alerts", "sound", "banner", "push"],
  },
  {
    section: "app-notifications",
  ...
  },
  {
    ...
    description: null,
    group: null,
    keywords: ["chime", "audio", "beep", "volume", "mute", "ding", "alert"],
  },
  {
    section: "app-notifications",
