/**
 * Whether the dock's Background section has anything to show.
 * It lives here rather than in the dock because the answer sizes the scroll region below and the composer's top spacing too: the dock's frame is drawn flush against what follows it, so a surface that disagrees leaves an open-bottomed box.
 */
