/** composer image-preparation: fallback and error cleanup */
import { afterEach, describe, expect, it, vi } from "vitest";

import { createImagePreparationSession } from "@/lib/composer/composer-image-preparation-session";
import {
...
import { SPLIT_CEILING_TEST_POLICY } from "./composer-image-preparation-test-helpers";
import type {
  CloseMock,
...
describe("composer image preparation: fallback and error cleanup", () => {
