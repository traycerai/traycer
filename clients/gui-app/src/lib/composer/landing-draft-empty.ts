...
/**
 * A draft is still a blank Start Page only while it has neither typed text nor an attached image.
 * Image-only drafts are real drafts even though their tab title falls back to "Start Page".
 */
