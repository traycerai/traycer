...
/**
 * Whether composer content can be sent: any non-whitespace text, or at least one image atom.
 * Shared by every composer surface (landing, New Conversation modal, …) so the "is this submittable" rule stays in lockstep.
 */
