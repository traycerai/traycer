...
// Canonical command surface for active-owner tile-find.
// Keyboard dispatch and the desktop menu both route through these functions so owner resolution, blocker policy, and replace-expansion live in one place instead of being re-implemented across `lib/keybindings/dispatch.ts` and the menu listener.
