...
/**
 * Canvas-tab descriptor fields for a worktree SETUP terminal, shared by the chat and terminal-agent tab-register drivers so the auto-opened tab is named and rooted identically on both surfaces (they converge on the same tab id).
 */
