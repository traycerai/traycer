 ...
 * and have no blocking selector reason. Setup runs as background enrichment;
 * its progress/outcome stays visible without making a created repo unusable. Shared by
