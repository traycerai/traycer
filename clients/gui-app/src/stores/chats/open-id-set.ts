 ...
 * (A2A send/received, subagent, and find-force) and by the communication-graph
 * detail rows (`stores/epics/comm-graph-row-open-store`) - every store that
 * keeps its opens as a plain `ReadonlySet<string>`.
 */
