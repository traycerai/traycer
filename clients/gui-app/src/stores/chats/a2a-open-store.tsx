...
interface A2AOpenStoreProviderProps {
  ...
  /**
   * `null` uses a fresh per-mount store (test isolation - see `ChatExpansionTestProviders`);
   * production passes the registry-backed store keyed by tile instance id (ticket 5) so it survives
   */
