...
function TextSegmentPart(props: TextSegmentPartProps) {
  ...
  // Own the gap above next-steps.
  // Body markdown and next-steps prose are separate `.md-prose` trees, and the Tailmark first/last margin zeroing in `index.css` collapses the trailing margin of the body (often a `---` rule) plus the leading margin of this prose - without this wrapper they stick.
  return (
