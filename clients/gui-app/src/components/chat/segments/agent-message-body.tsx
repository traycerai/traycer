...
/** Scrollable message text plus its copy affordance for an A2A send/received segment body. The copy button floats over the box's top-right corner (mirroring the artifact diff viewer's expand control); the box carries `pr-10` so text clears the button and keeps its own border + native scrollbar flush against that border. */
