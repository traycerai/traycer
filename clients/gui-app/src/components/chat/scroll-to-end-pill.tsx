...
export function ScrollToEndPill({
  ...
  return (
    <button
      ...
      className={cn(
        "pointer-events-auto absolute left-1/2 z-10 flex h-8 -translate-x-1/2 select-none items-center justify-center gap-1.5 whitespace-nowrap rounded-full bg-popover/95 ps-3 pe-2.5 font-medium text-popover-foreground text-ui-sm shadow-md ring-1 ring-foreground/10",
        "outline-none transition-[opacity,scale,background-color,box-shadow,color] duration-150 ease-out hover:bg-popover hover:shadow-lg hover:ring-foreground/15 active:scale-96 focus-visible:ring-2 focus-visible:ring-ring/70",
