    ...
    <Dialog>
      ...
      >
        ...
        <Button
          ...
          className="absolute right-0.5 top-0.5 z-10 size-4 rounded-full opacity-0 transition-opacity group-hover:opacity-100 focus-visible:opacity-100 pointer-coarse:opacity-100"
        >
