...
export function BrowserPeekTile(props: BrowserPeekTileProps) {
  ...
  // Both halves of the capture address, each absent on its own surface: the
  // Start Page panel's stream is device-scoped rather than epic-scoped, and a
  // viewer rendered outside a canvas tab has no view tab to open a file into.
