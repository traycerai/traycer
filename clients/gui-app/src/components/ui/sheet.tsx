    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          // Margin, not a `top`/`inset-y` override: those rules are variant- prefixed, and tailwind-merge only displaces
          // a class whose modifiers match, so a bare `top-safe-top` would tie rather than win.
