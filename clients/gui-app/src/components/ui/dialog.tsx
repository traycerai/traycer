    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          // `glass-with-insets`: every dialog app-wide opts into the shared
          // glass contract in `theme-surfaces.css` (outer blur off, a
          // second isolated layer behind the content) so nested overlays and
          // sticky insets can sample the real backdrop through it.
