...
// A key-cap glyph, and nothing more - it is equally the keybinding settings' rendering of a chord being
// edited.
  ...
  return (
    <kbd
      ...
      className={cn(
        ...
        // Riding the button's own foreground improves every preset and mode - never worse, and at least 1.67x on
        // `--primary` specifically (the `--secondary` minimum is only 1.002x, on everforest light).
