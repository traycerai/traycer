...
/**
 * PiP never attaches to the video broker, so its own JPEG cast runs for the whole life of the mirror - there is a live frame under the borrowed track, not a stale one, which is why this one keeps the layering the tile dropped.
 */
