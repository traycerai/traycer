...
function TabStripBody() {
  ...
  return (
    ...
    >
      <div className="relative flex min-w-0 max-w-full items-end">
        <LayoutGroup id="header-tabs">
          <div
            ref={trailingSlotRef}
            data-testid="header-tab-strip-scroll"
            onWheel={handleWheel}
            className="no-scrollbar flex w-max min-w-0 max-w-full flex-[0_1_auto] touch-pan-x items-end overflow-x-auto overscroll-x-contain"
          >
