...
// Takes `string | null`, matching the real hook: an absent open target is looked up as "no host", and a stub
// that only accepted a string would fail on the null rather than answering it.
