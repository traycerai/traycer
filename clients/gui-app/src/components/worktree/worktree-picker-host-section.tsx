...
/** The list is `useHostOptions`, not the raw directory: these popovers answer "what hosts do I have" the same
 * way Settings does, including the ones this client cannot dial. */
