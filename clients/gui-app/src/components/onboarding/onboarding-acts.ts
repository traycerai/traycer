...
export const ONBOARDING_ACTS: ReadonlyArray<OnboardingAct> = [
  {
    ...
    body: "Each Task tab holds one initiative: chats, artifacts, agents, terminals, and context stay together. Switch away, come back later, nothing scatters.",
    addon: null,
  },
  {
    id: "navigation",
    ...
    body: "The left lists are your map: chats, artifacts, and terminal agents. The canvas is where selected work opens, splits, and stays beside the conversation.",
    addon: null,
  },
  {
    id: "task-context",
    ...
    body: "Your GUI chat and terminal agents coordinate inside one Task: delegate work, report back, and stay in sync without you acting as the relay.",
    addon: null,
  },
  {
    id: "providers",
