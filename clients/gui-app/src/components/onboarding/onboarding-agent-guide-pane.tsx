...
/** The tour's live agent-selection-guide editor and the draft state the page owns for it. */
...
export function OnboardingAgentGuidePane(props: {
  ...
  return (
    // No host bar of its own: on desktop the picker is the title of the mini-app window this card floats in
    // (`DioramaScene`), and on the phone rail `ActCopy` heads the editor with it.
