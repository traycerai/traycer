...
interface SettingsSubgroupProps {
  /**
   * The subgroup's label, searchable copy and anchor, from the same definition
   * the index reads - the same contract `SettingsGroup` has, one level in, so
   * a nested card cannot exist without being indexed or folded into something
   * that is.
   */
  ...
  return (
    ...
    >
      <div
        ...
        data-settings-anchor={props.group.anchor ?? undefined}
