...
function StatusBarLayoutGroupContent(): ReactNode {
  ...
  return (
    ...
    >
      ...
      <SettingsRow
        row={LAYOUT.definitions.rateLimitsEnabled}
        control={
          <Switch
      ...
      />
      <SettingsRow
        row={LAYOUT.definitions.usageBar}
        control={
          <Switch
      ...
      <SettingsRow
        row={LAYOUT.definitions.resourcesEnabled}
        control={
          <Switch
...
interface ResourceMetricRow {
  ...
  /** The row it renders, which is also how search finds it. */
...
const RESOURCE_METRIC_ROWS: ReadonlyArray<ResourceMetricRow> = [
  {
    metric: "cpu",
    row: LAYOUT.definitions.metricCpu,
  },
  {
    metric: "memory",
    row: LAYOUT.definitions.metricMemory,
  },
  {
    metric: "processes",
    row: LAYOUT.definitions.metricProcesses,
  },
  {
    metric: "ramShare",
    row: LAYOUT.definitions.metricRamShare,
  },
];
