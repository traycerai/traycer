  ...
  return (
    ...
    >
      <div className={cn("flex flex-col", compact ? "gap-3.5" : "gap-5")}>
        ...
        {/* Tour replay used to sit here as an "Onboarding" group with one
            "Replay tour" row. It moved to its own Settings ▸ Onboarding page,
            which lists every tour and lesson with its progress. */}
        <DangerZoneSection />
      </div>
    </SettingsPanelShell>
  );
