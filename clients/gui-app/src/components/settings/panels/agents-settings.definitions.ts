...
// mode rows are dropped entirely on a host that advertises neither
...
// predicate can decide either, so all three contribute to the page instead and
// their vocabulary lands a search at the top of it.
