...
export function HarnessIcon(props: HarnessIconProps) {
  ...
  // Persisted selections (Zustand) can carry harness ids that are no longer in the catalog after a
  // rename/removal - fall back to a neutral square instead of crashing the whole app on `undefined.Icon`.
