...
export interface ProjectProfilesPersistLifecycleBridgeProps {
  readonly children: ReactNode;
}

export function ProjectProfilesPersistLifecycleBridge(
  props: ProjectProfilesPersistLifecycleBridgeProps,
): ReactNode {
