...
// Runner-aware `traycer config shell remove`.
// Forgets a `shell.entries` launch spec; if it was the selected shell, the selection falls back to the synthesised OS default.
