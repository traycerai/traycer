...
// `traycer link-phone` prints a QR (plus the same code as typeable text) for the Traycer mobile app to scan, then asks the human at this terminal to approve the phone that scanned it.
// Approval - never the scan - is what signs the phone in.
