...
// detected shells unioned with the user's remembered `shell.added` paths
// (`{ name, path, isDefault, source }`, OS default first). Human mode prints
// one `name<TAB>path` line per shell, marking the OS default with `*`.
//
