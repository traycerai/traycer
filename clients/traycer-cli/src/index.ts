    ...
    host
      ...
      .addHelpText(
        ...
        [
          ...
          "  Service-manager runs, non-TTY runs and --quiet stay silent, exactly as before;",
    ...
    host
      ...
      .addHelpText(
        ...
        [
          ...
          "",
          "macOS with Traycer Desktop managing the host is different, and step 3 does not",
          "fully apply. A host that is busy still refuses the install, but one that cannot be",
          "asked to stop is swapped under anyway, and no service is started afterwards:",
          "Desktop owns that registration, so the new bytes go live at its next register",
          "cycle or restart, and a host that was still running keeps serving the old ones",
          "until then. Run 'traycer host status' to see which version is actually live.",
          "",
        ].join("\n"),
      ),
    (opts) => {
    ...
    host
      ...
      .addHelpText(
        ...
        [
          ...
          "    not-attempted   nothing was started (--no-service, or Desktop-managed macOS,",
          "                    where the bytes go live at Desktop's next register cycle)",
