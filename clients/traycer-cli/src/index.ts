    ...
    program
      ...
      .addHelpText(
        ...
        [
          ...
          "  1  something was left behind - two different outcomes, and --json",
          "     tells them apart:",
          "       - the sign-out itself failed (another traycer process holds the",
          "         credentials lock). You are STILL SIGNED IN. --json emits an",
          "         error envelope, and the cache is deliberately left alone.",
